...
const AdminRequestedRides = () => {
  ...
  return (
    <View style={styles.mainContainer}>
      <Text style={styles.textTitle}>Requested Rides</Text>
      {ridesData.length >= 1 && (
        <View style={styles.mainContainer}>
          <View>
            <AppTextInput
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <Ccard
                  ...
                  onPress={() => navigation.navigate("pendingDetails", item)}
                />
              )}
            />
          </ScrollView>
      ...
      {ridesData.length === 0 && (
        <View style={styles.mainContainerNo}>
          <Text style={styles.text}>No Requested Rides to show</Text>
        </View>
      )}
    </View>
  );
...
export default AdminRequestedRides;
